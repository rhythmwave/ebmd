...
class KibDDataTable extends DataTable
{
    /**
     ...
     */
    protected string $dataTableVariable = 'dataTableKIBD';
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', 'kibd.action')
            ->setRowId('id');
    }
     ...
     */
    public function query(KibD $model): QueryBuilder
    {
